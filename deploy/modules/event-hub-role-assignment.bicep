...
var schemaRegistryContributorRoleId = subscriptionResourceId('Microsoft.Authorization/roleDefinitions', '5dffeca3-4936-4216-b2bc-10343a5abb25')
...
resource schemaRegistryContributorRole 'Microsoft.Authorization/roleAssignments@2022-04-01' = {
  name: guid(eventHub.id, functionAppId, schemaRegistryContributorRoleId)
  scope: eventHub
  properties: {
    principalId: functionAppPrincipalId
    roleDefinitionId: schemaRegistryContributorRoleId
    principalType: 'ServicePrincipal'
  }
}
